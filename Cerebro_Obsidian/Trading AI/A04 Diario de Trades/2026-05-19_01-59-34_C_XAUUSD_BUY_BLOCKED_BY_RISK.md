# Relatório de Trade - C:XAUUSD (🟢 BUY) - ⏳ PENDING
 
---
 
## 1. Informações Gerais
- **Data e Hora**: 2026-05-19T01:59:34.584455
- **Ativo**: C:XAUUSD
- **Direção**: BUY
- **Tempo Gráfico**: N/A
- **Preço de Entrada**: 2420.5
- **Stop Loss**: 2419.73
- **Take Profit**: 2422.81
- **Relação Risco:Retorno (R:R)**: 3.0
- **Lote / Tamanho do Trade**: 0.0 (Equivale a 1% de risco)
 
---
 
## 2. Raciocínio da IA (Chain-of-Thought)
### OPERAÇÃO BLOQUEADA PELO GESTOR DE RISCO QUANTITATIVO

**Motivo**: Metas diárias alcançadas! Lucro acumulado hoje de 250.00%. Meta: 5.0%
...
- **Killzone**: PENDENTE
- **Varredura de Liquidez**: PENDENTE
- **MSS Confirmado**: PENDENTE
- **Payout Mínimo Atendido**: REJEITADO
