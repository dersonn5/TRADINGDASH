...
- 17x: deslocamento c2 não tem volume institucional suficiente (body < 1.5*atr)
...
- 2x: sem sweep do PDH desde 04:00 EST

### `sweep_present_bullish` (1 falhas)
- 1x: sem sweep do PDL desde 04:00 EST
...
| 2026-04-22 10:05:00-04:00 | 5/6 | `fvg_has_displacement` | deslocamento c2 não tem volume institucional suficiente (body < 1.5*atr) |
...
| 2026-04-22 10:35:00-04:00 | 5/6 | `fvg_has_displacement` | deslocamento c2 não tem volume institucional suficiente (body < 1.5*atr) |
...
| 2026-04-23 10:00:00-04:00 | 8/9 | `sweep_present_bearish` | sem sweep do PDH desde 04:00 EST |
...
| 2026-04-23 10:25:00-04:00 | 5/6 | `fvg_has_displacement` | deslocamento c2 não tem volume institucional suficiente (body < 1.5*atr) |
