...
| 7 | `fvg_present_any` | 432 | 159 | 273 | 36.8% |
| 8 | `setup_combo_valid` | 159 | 11 | 148 | 6.9% |
| 9 | `mss_confirmed_bearish` | 11 | 2 | 9 | 18.2% |
| 10 | `m1_confirmation` | 2 | 0 | 2 | 0.0% |
...
| 3 | `fvg_present_any` | 273 | 4.8% |
| 4 | `setup_combo_valid` | 148 | 2.6% |
| 5 | `mss_confirmed_bearish` | 9 | 0.2% |
...
### `fvg_present_any` (273 falhas)
- 273x: nenhum FVG ativo nos últimos 12 candles M5

### `setup_combo_valid` (148 falhas)
- 148x: sweep + FVG + bias não alinharam na mesma direção

### `mss_confirmed_bearish` (9 falhas)
- 9x: fechamento atual não rompeu swing low recente

### `m1_confirmation` (2 falhas)
- 2x: M1 sem MSS+FVG/BPR confirmado na zona do FVG M5
...
| 2026-04-22 03:45:00-04:00 | 9/10 | `m1_confirmation` | M1 sem MSS+FVG/BPR confirmado na zona do FVG M5 |
| 2026-04-22 03:50:00-04:00 | 9/10 | `m1_confirmation` | M1 sem MSS+FVG/BPR confirmado na zona do FVG M5 |
