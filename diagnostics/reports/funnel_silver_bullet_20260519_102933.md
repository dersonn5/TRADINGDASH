...
| 6 | `fvg_has_displacement` | 156 | 113 | 43 | 72.4% |
| 7 | `fvg_present_any` | 113 | 2 | 111 | 1.8% |
| 8 | `fvg_aligned_with_bias` | 2 | 1 | 1 | 50.0% |
| 9 | `sweep_present_bullish` | 1 | 0 | 1 | 0.0% |
...
| 4 | `fvg_has_displacement` | 43 | 2.7% |
| 5 | `sweep_present_bullish` | 1 | 0.1% |
...
### `fvg_has_displacement` (43 falhas)
- 43x: deslocamento c2 não tem volume institucional suficiente (body < 1.5*atr)
...
|---|---:|---|---|
| 2026-04-21 10:00:00-04:00 | 5/6 | `fvg_has_displacement` | deslocamento c2 não tem volume institucional suficiente (body < 1.5*atr) |
...
| 2026-04-21 10:25:00-04:00 | 5/6 | `fvg_has_displacement` | deslocamento c2 não tem volume institucional suficiente (body < 1.5*atr) |
...
| 2026-04-21 10:45:00-04:00 | 5/6 | `fvg_has_displacement` | deslocamento c2 não tem volume institucional suficiente (body < 1.5*atr) |
| 2026-04-21 10:50:00-04:00 | 5/6 | `fvg_has_displacement` | deslocamento c2 não tem volume institucional suficiente (body < 1.5*atr) |
| 2026-04-21 10:55:00-04:00 | 6/7 | `fvg_present_any` | nenhum FVG nos últimos 3 candles M5 |
| 2026-04-22 10:00:00-04:00 | 5/6 | `fvg_has_displacement` | deslocamento c2 não tem volume institucional suficiente (body < 1.5*atr) |
...
| 2026-04-22 10:15:00-04:00 | 5/6 | `fvg_has_displacement` | deslocamento c2 não tem volume institucional suficiente (body < 1.5*atr) |
| 2026-04-22 10:20:00-04:00 | 5/6 | `fvg_has_displacement` | deslocamento c2 não tem volume institucional suficiente (body < 1.5*atr) |
| 2026-04-22 10:25:00-04:00 | 5/6 | `fvg_has_displacement` | deslocamento c2 não tem volume institucional suficiente (body < 1.5*atr) |
...
| 2026-04-24 10:10:00-04:00 | 5/6 | `fvg_has_displacement` | deslocamento c2 não tem volume institucional suficiente (body < 1.5*atr) |
