...
| 3 | `bias_not_neutral` | 714 | 427 | 287 | 59.8% |
| 4 | `asian_range_valid` | 427 | 427 | 0 | 100.0% |
| 5 | `killzone_has_candles` | 427 | 427 | 0 | 100.0% |
| 6 | `enough_candles_for_fvg` | 427 | 427 | 0 | 100.0% |
| 7 | `fvg_present_any` | 427 | 155 | 272 | 36.3% |
| 8 | `setup_combo_valid` | 155 | 7 | 148 | 4.5% |
| 9 | `mss_confirmed_bearish` | 7 | 1 | 6 | 14.3% |
| 10 | `signal_generated` | 1 | 1 | 0 | 100.0% |
| 11 | `cooldown_passed` | 662 | 657 | 5 | 99.2% |
...
### `fvg_present_any` (272 falhas)
- 272x: nenhum FVG ativo nos últimos 12 candles M5

### `setup_combo_valid` (148 falhas)
- 148x: sweep + FVG + bias não alinharam na mesma direção

### `mss_confirmed_bearish` (6 falhas)
- 6x: fechamento atual não rompeu swing low recente
...
## Near-misses (passaram >=80% dos gates) — 426 candles
...
|---|---|---:|---:|---:|
| 2026-04-22 03:45:00-04:00 | SELL | 4784.85 | 4792.85 | 4768.85 |
